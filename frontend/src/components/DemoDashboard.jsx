  ...
  return (
    <main className="preview-page">
      <div className="preview-shell">
        ...
        <div className="preview-links"><Link className="btn" to="/">Volver al inicio</Link><a className="btn primary" href="https://github.com/Pumpurri/investment-portfolio-simulator">Explorar el código</a></div>
      </div>
    </main>
  );
}
